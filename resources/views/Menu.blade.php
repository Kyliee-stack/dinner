    ...
    @push('styles')
        <style>
            ...
            .card-img {
                ...
                /* Tinggi tetap untuk rasio kotak seragam */
                object-fit: cover !important;
                /* Memastikan gambar mengisi ruang tanpa meregang (akan di-crop di tepi) */
                display: block;
            }
            ...
            /* ======== FLOATING CART BAR BARU (Gambar ke-2) ======== */
            .floating-cart-bar {
            ...
            .cart-icon-container .cart-icon {
                /* Menggunakan kode entitas HTML atau Unicode Anda */
                color: #ff4081;

                /* Tambahkan background putih dan padding agar ikon berada di lingkaran putih */
                background-color: white;
                padding: 6px 8px;
                /* Sesuaikan padding agar lingkaran menutupi ikon */
                border-radius: 50%;
            }
            ...
            .cart-badge {
                ...
                /* ❗ Warna teks Pink (sama dengan warna bar) ❗ */
        ...
        @section('content')
            ...
            <div class="page-wrapper">
                <div class="kolom-kiri">
                    ...
                    <div class="tab-navigation">
                        <a href="{{ route('menu.index', ['category' => 'MIE DINE IN']) }}"
                            class="tab-item {{ $category == 'MIE DINE IN' ? 'active' : '' }}">MIE DINE IN</a>
                        <a href="{{ route('menu.index', ['category' => 'DIMSUM DINE IN']) }}"
                            class="tab-item {{ $category == 'DIMSUM DINE IN' ? 'active' : '' }}">DIMSUM DINE IN</a>
                        <a href="{{ route('menu.index', ['category' => 'ES BUAH']) }}"
                            class="tab-item {{ $category == 'ES BUAH' ? 'active' : '' }}">ES BUAH</a>
                    </div>
                    ...
                    <div class="menu-list-container">
                        ...
                        @foreach ($menus ?? [] as $menu)
                            <div class="card" data-menu-id="{{ $menu->id ?? 0 }}">
                                ...
                                <img src="{{ asset('images/' . ($menu->image ?? 'default.jpg')) }}" alt="{{ $menu->name }}"
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-footer-control">
                                        @php
                                            // Mengambil Qty saat ini menggunakan $menu->id
            ...
            {{-- BOTTOM BAR CHECKOUT (BARU) --}}
            {{-- Ini adalah kode yang akan membuat tampilan keranjang kecil dan bulat di bawah --}}
                ...
                <div class="floating-cart-bar">
                    <div class="cart-details">
                        <div class="cart-icon-container">
                            ...
                            {{-- Menggunakan kode entitas HTML untuk ikon keranjang agar tampil di berbagai browser --}}
